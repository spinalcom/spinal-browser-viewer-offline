...
Autodesk.ADN.Viewing.Extension.Color = function(viewer, options) {
    ...
    _self.load = function() {
        ...
        function addMaterial(color,id) {
            ...
            viewer.impl.createOverlayScene(id, material, material);
            return material;
        }
        ...
        Autodesk.Viewing.Viewer3D.prototype.setColorMaterial = function(objectIds, color,id) {
            ...
            for (var i=0; i<objectIds.length; i++) {
                ...
                it.enumNodeFragments(dbid, function (fragId) {
                    ...
                    viewer.impl.addOverlay(id, renderProxy[id]);
            ...
            for (var i = 0; i < objectIds.length; i++) {
                ...
                it.enumNodeFragments(dbid, function (fragId) {
                    ...
                    if(renderProxy[id]){
                      ...
                      viewer.impl.clearOverlay(id);
                      //viewer.impl.removeOverlay(id, renderProxy[id]);
