...
"use strict";angular.module("app.spinalforge.plugin").controller("forgeViewerCtrl",["$scope","$rootScope","$mdDialog","authService","$compile","$injector","layout_uid","spinalModelDictionary",function(e,o,i,n,t,a,d,r){e.injector=a,e.uid=d.get(),o.allNotes=[],r.init().then(function(o){var i,n,t={inViewerSearchConfig:{uiEnabled:!0,clientId:"dsadsa",sessionId:"F969EB70-242F-11E6-BDF4-0800200C9A66",loadedModelTab:{enabled:!0,displayName:"This View",pageSize:50},relatedItemsTab:{enabled:!0,displayName:"This Item",pageSize:20}}},a=["PannelAnnotation","Autodesk.ADN.Viewing.Extension.Color"],d={env:"Local",docid:""};o.urn.get();if(0!=(n=o._children.get()).length){for(var r=n[0].path,l=0;l<n.length;l++)if(/.+\.svf$/.test(n[l].path)){r=n[l].path;break}d.docid=r}function onDocumentLoadFailure(e){console.error("onDocumentLoadFailure() - errorCode:"+e)}function onItemLoadSuccess(o,n){o.scope=e,i.addEventListener(Autodesk.Viewing.GEOMETRY_LOADED_EVENT,function onGeometryLoadEvent(){i.removeEventListener(Autodesk.Viewing.GEOMETRY_LOADED_EVENT,onGeometryLoadEvent);for(var e=0;e<a.length;e++)i.loadExtension(a[e],d)})}i=new Autodesk.Viewing.Private.GuiViewer3D($("#MyViewerDiv"+e.uid)[0],t),Autodesk.Viewing.Initializer(d,function(){i.initialize(),console.log(d.docid),i.loadModel(d.docid,t,onItemLoadSuccess,onDocumentLoadFailure)})})}]);
